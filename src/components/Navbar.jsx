...
const Navbar = () => {
    ...
    <nav className="bg-[#4F46E5] w-full z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-2">
          <img src={logo} alt="AT Digital Logo" className="h-6 w-auto" />
        </div>
        {/* Desktop Menu */}
  ...
  <button className="md:hidden text-white focus:outline-none cursor-pointer" onClick={() => setMenuOpen(!menuOpen)}>
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <ul className="md:hidden flex flex-col items-center space-y-4 text-white text-base font-medium bg-[#4F46E5] pb-4">
